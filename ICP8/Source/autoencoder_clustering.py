...
def read_NewsGroup_data(similarity):    
    categories_3NG = ['comp.graphics', 'rec.sport.baseball', 'talk.politics.guns', 'rec.sport.hockey', 'comp.sys.mac.hardware' ]
...
stop_learning = 1.3 #--------------------- The stop learning point.
